...
mod = '"kit00"' # builder; kitti_explain start, copied from carla_explain
mod = '"kit01"' # again; 20 iters; do not discard based on cam motion
mod = '"kit02"' # return after summ
mod = '"kit03"' # tester; print when we leave early
mod = '"kit04"' # use the cache
# mean_proposal_maps_3d [0.18 0.18 0.13 0.1  0.06 0.02 0.01]
# mean_proposal_maps_2d [0.18 0.18 0.16 0.12 0.09 0.06 0.02]
# mean_proposal_maps_pers [0.22 0.19 0.18 0.18 0.16 0.13 0.07]
# mean_track_maps_3d [0.08 0.06 0.03 0.   0.   0.   0.  ]
# mean_track_maps_2d [0.08 0.07 0.04 0.03 0.01 0.   0.  ]
# mean_track_maps_pers [0.11 0.09 0.05 0.05 0.03 0.01 0.  ]

mod = '"kit05"' # discard boxes >40
# somehow identical to kit04
mod = '"kit06"' # req center occ
# mean_proposal_maps_3d [0.2  0.18 0.11 0.09 0.05 0.02 0.  ]
# mean_proposal_maps_2d [0.2  0.19 0.15 0.11 0.08 0.04 0.02]
# mean_proposal_maps_pers [0.24 0.21 0.2  0.19 0.17 0.13 0.07]
# mean_track_maps_3d [0.2  0.16 0.13 0.06 0.03 0.01 0.01]
# mean_track_maps_2d [0.2  0.2  0.16 0.14 0.07 0.03 0.02]
# mean_track_maps_pers [0.24 0.21 0.16 0.15 0.08 0.05 0.01]
# somehow this is worse. so let's drop that constraint

mod = '"kit07"' # req dist < 10
# mean_proposal_maps_3d [0.11 0.1  0.08 0.07 0.05 0.02 0.  ]
# mean_proposal_maps_2d [0.11 0.11 0.09 0.08 0.06 0.05 0.02]
# mean_proposal_maps_pers [0.15 0.13 0.11 0.1  0.09 0.06 0.03]
# mean_track_maps_3d [0.13 0.11 0.1  0.07 0.01 0.   0.  ]
# mean_track_maps_2d [0.13 0.12 0.11 0.09 0.08 0.01 0.  ]
# mean_track_maps_pers [0.17 0.13 0.13 0.12 0.05 0.02 0.01]

mod = '"kit08"' # don't do the inb check; return after proposing
mod = '"kit09"' # any cam motion; any inb; 
mod = '"kit10"' # any cam motion; any inb; use some feat cache
# finished; mostly this printed feats
mod = '"kit11"' # use more feat cache; 100 iters
# mean_proposal_maps_3d [0.17 0.14 0.11 0.09 0.07 0.04 0.01]
# mean_proposal_maps_2d [0.18 0.15 0.13 0.11 0.09 0.07 0.05]
# mean_proposal_maps_pers [0.24 0.2  0.18 0.16 0.14 0.11 0.07]

mod = '"kit12"' # show summs; use 0.99 to measure movemnet
# mean_proposal_maps_3d [0.16 0.14 0.11 0.09 0.07 0.04 0.01]
# mean_proposal_maps_2d [0.18 0.15 0.13 0.1  0.09 0.07 0.05]
# mean_proposal_maps_pers [0.24 0.2  0.18 0.16 0.14 0.11 0.07]
...
groups['kitti_explain'] = ['do_kitti_explain = True']
