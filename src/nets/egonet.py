...
def eval_against_gt(loss, cam0_T_cam1_e, cam0_T_cam1_g,
    ...
    loss = utils.misc.add_loss('ego/t_sql2_%.2f' % sc,
                               loss,
                               t_l2,
                               t_coeff,
    ...
    loss = utils.misc.add_loss('ego/deg_sql2_%.2f' % sc,
                               loss,
                               deg_l2,
                               deg_coeff,
                               summ_writer=summ_writer)
...
class EgoNet(nn.Module):
    ...
    def forward(self, feat0, feat1, cam0_T_cam1_g, vox_util, summ_writer=None, reuse=False):
        total_loss = 0.0
    ...
    def multi_scale_corr3Dr(self, total_loss, feat0, feat1, vox_util, summ_writer=None, cam0_T_cam1_g=None, reuse=False, do_print=False):
        # the idea here is:
